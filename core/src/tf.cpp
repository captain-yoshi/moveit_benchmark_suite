...
Eigen::Isometry3d TF::identity()
{
  return Eigen::Isometry3d::Identity();
}

Eigen::Isometry3d TF::createPoseXYZ(double x, double y, double z)
{
  return createPoseXYZ(x, y, z, 0, 0, 0);
}

Eigen::Isometry3d TF::createPoseXYZ(const Eigen::Ref<const Eigen::Vector3d>& translation)
{
...
Eigen::Isometry3d TF::createPoseXYZ(double x, double y, double z, double X, double Y, double Z)
{
...
Eigen::Isometry3d TF::createPoseQ(double x, double y, double z, double W, double X, double Y, double Z)
{
  return createPoseQ(Eigen::Vector3d{ x, y, z },  //
                     Eigen::Vector4d{ W, X, Y, Z });
}

Eigen::Isometry3d TF::createPoseQ(const Eigen::Ref<const Eigen::Vector3d>& translation,
...
Eigen::Quaterniond TF::getPoseRotation(const Eigen::Isometry3d& pose)
{
...
{
  return Eigen::Isometry3d(Eigen::Translation3d(msg.position.x, msg.position.y, msg.position.z) *
...
moveit_msgs::BoundingVolume TF::getBoundingVolume(const Eigen::Isometry3d& pose, const GeometryConstPtr& geometry)
{
...
Eigen::Isometry3d TF::samplePoseUniform(const Eigen::Vector3d& pos_bounds, const Eigen::Vector3d& orn_bounds)
{
  auto sampled = Eigen::Isometry3d::Identity();
...
Eigen::Isometry3d TF::samplePoseGaussian(const Eigen::Vector3d& pos_variances, const Eigen::Vector3d& orn_bounds)
{
  auto sampled = Eigen::Isometry3d::Identity();
...
Eigen::Isometry3d TF::transformMsgToEigen(const geometry_msgs::TransformStamped& tf)
{
