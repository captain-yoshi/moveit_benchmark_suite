...
T* attachObjectHelper(
    ...
    typename std::enable_if<has_member_function_getPose<const Eigen::Isometry3d& (T::*)() const>::value>::type* dummy = 0)
{
  return new T(ee,                             //
               id,                             //
...
T* attachObjectHelper(
    ...
    const EigenSTL::vector_Isometry3d shape_poses,     //
    const std::set<std::string>& touch_links,          //
    typename std::enable_if<not has_member_function_getPose<const Eigen::Isometry3d& (T::*)() const>::value>::type*
        dummy = 0)
{
  return new T(ee,           //
               id,           //
...
// void moveit_benchmark_suite::core::getTransformsFromTf(std::vector<geometry_msgs::TransformStamped>& transforms,
...
// void moveit_benchmark_suite::core::addTransformsToSceneMsg(
//     const std::vector<geometry_msgs::TransformStamped>& transforms, moveit_msgs::PlanningScene& scene_msg)
// {
